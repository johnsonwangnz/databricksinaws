...
# MAGIC To run this demo, just select the cluster `dbdemos-auto-loader-johnson_wang` from the dropdown menu ([open cluster configuration](https://dbc-f13b9f25-76cb.cloud.databricks.com/#setting/clusters/0921-224250-powynigh/configuration)). <br />
...
# MAGIC
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fauto-loader%2F01-Auto-loader-schema-evolution-Ingestion&cid=local&uid=local">

# COMMAND ----------

# DBTITLE 1,Data initialization - run the cell to prepare the demo data.
#%run ./_resources/00-setup $reset_all_data=$reset_all_data
dbutils.widgets.text("raw_data_location", "s3a://jwhqun6d-autoloader-bucket/demos/raw_data", "Raw data location (stating dir)")
...
bronzeDF = (spark.readStream \
            ...
            # this is using notification mode
