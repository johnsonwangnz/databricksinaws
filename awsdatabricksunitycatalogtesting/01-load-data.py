...
dbutils.widgets.text("raw_data_location", "s3://jwhqun6d-autoloader-bucket/demos/raw_data", "Raw data location (stating dir)")
...
df.repartition(100).write.mode("append").format("json").save(raw_data_location+"/user_json")
